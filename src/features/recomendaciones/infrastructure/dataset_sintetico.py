...
# (el pegazulejo es casi obligatorio; emboquillado a veces se cotiza aparte).
# Nombres iguales a las categorías reales de Proveedores (dataset_real.py) —
# si no coinciden, el K-NN cuenta "boquilla" y "emboquillado" como cosas
# distintas y diluye el voto en vez de sumarlo.
_PROB_COMPLEMENTO = {"pegazulejo": 0.95, "cruceta": 0.90, "emboquillado": 0.72}
